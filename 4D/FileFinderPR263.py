...
"""See docstring for FileFinderPR263 class"""
...
__all__ = ["FileFinderPR263"]

class FileFinderPR263(DmgMounter):
    ...
    def main(self):
        ...
        try:
            ...
            if dmg and match.startswith(mount_point):
                self.env['dmg_found_filename'] = match[len(mount_point):].lstrip(os.path.sep)
